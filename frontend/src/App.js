...
function Nav({active,go}){
  ...
  return(
    <div style={{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:430,background:"rgba(247,249,245,.97)",backdropFilter:"blur(20px)",borderTop:`1.5px solid ${C.border}`,display:"flex",zIndex:999,paddingBottom:16,paddingTop:10,boxShadow:"0 -4px 24px rgba(143,175,139,.12)"}}>
      {tabs.map(t=>{
...
function Home({go}){
  ...
  return(
    <div style={{padding:"52px 18px 90px",overflowY:"auto",maxHeight:"100dvh",background:C.bg}}>
...
function CheckIn({go}){
  ...
  if(result){
    ...
    return(
      <div style={{padding:"52px 18px 90px",overflowY:"auto",background:C.bg}}>
  ...
  return(
    <div style={{padding:"52px 18px 90px",background:C.bg}}>
...
export default function App(){
  ...
  return(
    <>
      <style>{G}</style>
      <div style={{width:"100%",maxWidth:430,minHeight:"100dvh",background:C.bg,fontFamily:"'DM Sans',sans-serif",position:"relative",margin:"0 auto"}}>
        <Screen go={setScreen}/>
